...
namespace IIS.KuRsAvAAAAA
{
    ...
    [View("ЧекE", new string[] {
            ...
            "ЗаправкаАвто.ЗаправБак.ТипТопл as \'Тип топлива\'",
            "ЗаправкаАвто.ЗаправБак.Цена as \'Цена\'",
            "Клиент.КартаЛояль.Ном as \'Карта лояльности\'",
            "Клиент.КартаЛояль.ПроцСкид as \'Процент скидки\'",
            "Сумма as \'Сумма чека\'"})]
    ...
    public class Чек : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KuRsAvAAAAA.ЗаправкаАвто fЗаправкаАвто;
        
        private IIS.KuRsAvAAAAA.Клиент fКлиент;
        
        private IIS.KuRsAvAAAAA.DetailArrayOfТЧТовары fТЧТовары;
        ...
        [PropertyStorage(new string[] {
                "ЗаправкаАвто"})]
        [NotNull()]
        public virtual IIS.KuRsAvAAAAA.ЗаправкаАвто ЗаправкаАвто
        {
            get
            {
                ...
                IIS.KuRsAvAAAAA.ЗаправкаАвто result = this.fЗаправкаАвто;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KuRsAvAAAAA.Клиент Клиент
        {
            get
            {
                ...
                IIS.KuRsAvAAAAA.Клиент result = this.fКлиент;
        ...
        public virtual IIS.KuRsAvAAAAA.DetailArrayOfТЧТовары ТЧТовары
        {
            get
            {
                ...
                {
                    this.fТЧТовары = new IIS.KuRsAvAAAAA.DetailArrayOfТЧТовары(this);
                }
                IIS.KuRsAvAAAAA.DetailArrayOfТЧТовары result = this.fТЧТовары;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЧекE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЧекE", typeof(IIS.KuRsAvAAAAA.Чек));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЧекL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЧекL", typeof(IIS.KuRsAvAAAAA.Чек));
                }
            }
        }
    }

...
namespace IIS.KuRsAvAAAAA
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KuRsAvAAAAA.КартаЛояль fКартаЛояль;
        
        private IIS.KuRsAvAAAAA.БанкДан fБанкДан;
        ...
        [PropertyStorage(new string[] {
                "БанкДан"})]
        [NotNull()]
        public virtual IIS.KuRsAvAAAAA.БанкДан БанкДан
        {
            get
            {
                ...
                IIS.KuRsAvAAAAA.БанкДан result = this.fБанкДан;
        ...
        [PropertyStorage(new string[] {
                "КартаЛояль"})]
        [NotNull()]
        public virtual IIS.KuRsAvAAAAA.КартаЛояль КартаЛояль
        {
            get
            {
                ...
                IIS.KuRsAvAAAAA.КартаЛояль result = this.fКартаЛояль;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.KuRsAvAAAAA.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.KuRsAvAAAAA.Клиент));
                }
            }
        }
    }
